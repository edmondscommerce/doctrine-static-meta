...
{
    public const WORK_DIR = AbstractIntegrationTest::VAR_PATH.'/'.self::TEST_TYPE.'/ShortIndexedRequiredStringFieldTraitTest/';
    ...
    protected const TEST_FIELD_DEFAULT = ShortIndexedRequiredStringFieldInterface::DEFAULT_SHORT_INDEXED_REQUIRED_STRING;
}
