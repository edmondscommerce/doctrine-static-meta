...
trait DSMEntityTrait
{
    /**
     * @var DoctrineStaticMeta
     */
    protected static $doctrineStaticMeta;
    /**
     * @var ValidatorStaticMeta|null
     */
    protected static $validatorStaticMeta;
    /**
     ...
     * @var bool
     */
    protected $creationTransactionRunning = false;
    /**
     * @var array PropertyChangedListener[]
     */
    protected $notifyChangeTrackingListeners = [];
     ...
     * @throws ReflectionException
     */
    final protected function runInitMethods(): void
    {
    ...
    final public static function getEntityFqn(): string
    {
        return static::class;
    }
     ...
     */
    final public static function loadMetadata(DoctrineClassMetaData $metaData): void
    {
        try {
     ...
     * @throws DoctrineStaticMetaException
     */
    final public static function loadValidatorMetaData(ValidatorClassMetaData $metadata): void
    {
     ...
     */
    final protected static function getValidatorStaticMeta(): ValidatorStaticMeta
    {
     ...
     * @throws ReflectionException
     */
    final public static function getDoctrineStaticMeta(): DoctrineStaticMeta
    {
    ...
    final public function getValidator(): EntityDataValidatorInterface
    {
     ...
     */
    final public function injectEntityDataValidator(EntityDataValidatorInterface $entityDataValidator): void
    {
     ...
     */
    final public function addPropertyChangedListener(PropertyChangedListener $listener): void
    {
     ...
     */
    final public function removePropertyChangedListeners(): void
    {
     ...
     * @throws ReflectionException
     */
    final public function ensureMetaDataIsSet(EntityManagerInterface $entityManager): void
    {
     ...
     * @throws ReflectionException
     */
    final public function notifyEmbeddablePrefixedProperties(
     ...
     *
     */
    final protected function updatePropertyValue(string $propName, $newValue): void
    {
     ...
     */
    final protected function removeFromEntityCollectionAndNotify(string $propName, EntityInterface $entity): void
    {
     ...
     * @param EntityInterface $entity
     */
    final protected function addToEntityCollectionAndNotify(string $propName, EntityInterface $entity): void
    {
        if ($this->$propName === null) {
            $this->$propName = new ArrayCollection();
        }
     ...
     */
    final protected function setEntityAndNotify(string $propName, ?EntityInterface $entity): void
    {
